	Nios_System_4A u0 (
		...
		.seg1_pio_external_connection_export   (<connected-to-seg1_pio_external_connection_export>),   //   seg1_pio_external_connection.export
		.seg2_pio_external_connection_export   (<connected-to-seg2_pio_external_connection_export>),   //   seg2_pio_external_connection.export
		.seg3_pio_external_connection_export   (<connected-to-seg3_pio_external_connection_export>),   //   seg3_pio_external_connection.export
		.seg4_pio_external_connection_export   (<connected-to-seg4_pio_external_connection_export>),   //   seg4_pio_external_connection.export
