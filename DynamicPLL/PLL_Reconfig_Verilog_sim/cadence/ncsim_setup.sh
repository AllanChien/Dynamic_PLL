...
TOP_LEVEL_NAME="PLL_Reconfig_Verilog"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/PLL_Reconfig_Verilog/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work PLL_Reconfig_Verilog -cdslib ./cds_libs/PLL_Reconfig_Verilog.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work PLL_Reconfig_Verilog -cdslib ./cds_libs/PLL_Reconfig_Verilog.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work PLL_Reconfig_Verilog -cdslib ./cds_libs/PLL_Reconfig_Verilog.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_Reconfig_Verilog.v"                                                                                                   
fi
