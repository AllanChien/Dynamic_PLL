...
# ACDS 20.1 720 win32 2024.06.28.15:37:49
# ----------------------------------------
...
# ----------------------------------------
# If PLL_MS_Verilog is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_MS_Verilog"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_MS_Verilog.vo"
}
